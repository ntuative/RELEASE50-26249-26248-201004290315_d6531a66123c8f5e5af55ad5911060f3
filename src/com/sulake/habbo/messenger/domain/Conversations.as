package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private var var_445:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_669,0,var_445.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_445.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_445.getTabCount());
      ...
      {
         return var_445.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(_startIndex + var_445.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_445.addMsgToView(_loc3_,_loc4_);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_445.addMsgToView(_loc3_,param1);
