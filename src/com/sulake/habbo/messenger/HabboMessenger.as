package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_309:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_891,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_588.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_588.setSelected(_loc2_);
            var_309.openMessenger();
            var_309.refresh(true);
         }
      }
      ...
      {
         var_588.addMessageAndUpdateView(param1);
         if(!var_309.isMessengerOpen())
         {
      ...
      {
         var_588 = new Conversations(new ConversationsDeps(this));
         var_309 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_588.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_588.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var_588.addMessageAndUpdateView(_loc3_);
      }
