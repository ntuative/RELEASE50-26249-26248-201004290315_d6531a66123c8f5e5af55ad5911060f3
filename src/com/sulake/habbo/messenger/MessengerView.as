package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1277:ConversationView;
      
      private var var_14:IFrameWindow;
      
      private var var_428:Timer;
      
      private var var_739:ITextFieldWindow;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_739.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_739.text = "";
         var_137.conversations.addMessageAndUpdateView(new Message(Message.const_620,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      private function prepareContent() : void
      {
         ...
         var_874 = new ConversationsTabView(var_137,var_14);
         var_874.refresh();
         var_739 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_739.addEventListener(WindowKeyboardEvent.const_145,onMessageInput);
         var_1277 = new ConversationView(var_137,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_525,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_807,true);
      }
   }
}
