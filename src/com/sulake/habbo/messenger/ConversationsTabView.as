package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_892 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_159 ? var_137.conversations.findConversation(param2.id) : var_137.conversations.openConversations[_loc3_ + var_137.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         var _loc3_:IWindowContainer = var_892.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
