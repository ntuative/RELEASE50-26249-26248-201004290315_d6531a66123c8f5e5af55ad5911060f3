package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_799:int = 100;
       
      
      private var var_2260:IScrollbarWindow;
      
      private var var_137:HabboMessenger;
      
      private var var_1613:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_137 = param1;
         var_1613 = initButton("follow_friend",onFollowButtonClick,param2);
         var_50 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2260 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_620 || param3.type == Message.const_640 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_545.messages.length - const_799);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_545.messages.length)
         {
            refreshEntry(true,_loc1_,var_545.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_545 == null || _loc1_.id != var_545.id)
         {
            var_545 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_799 + const_1138)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_137.send(new FollowFriendMessageComposer(var_545.id));
      }
