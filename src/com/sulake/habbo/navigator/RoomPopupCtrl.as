package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_1677:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1677 = new RoomThumbnailRenderer(param1);
         var_784 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_168,var_113.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_168.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_168.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_784.refreshTags(_loc1_,var_113.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1677.refreshThumbnail(_loc1_,var_113.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_168 == null)
         {
            var_168 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_168.visible = true;
         Util.hideChildren(var_168);
         refreshRoomName(var_168,var_113);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_168,!true ? getEventCtg(var_113.categoryId) : getRoomCtg(var_113.categoryId));
         refreshRoomDesc(var_168,var_113);
         refreshExtraCont();
         refreshInfo(var_168,"trading_allowed",var_113.allowTrading);
         refreshInfo(var_168,"doormode_doorbell",false);
         refreshInfo(var_168,"doormode_password",false);
         Util.moveChildrenToColumn(var_168,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_168.height = Util.getLowestPoint(var_168);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_216,Tabs.const_227,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
