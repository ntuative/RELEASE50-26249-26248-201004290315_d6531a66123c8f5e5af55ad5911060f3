package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1536,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1537,this._model.mode != ThumbnailEditorModel.const_36);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1536 = IButtonWindow(find("top_tab"));
         var_1537 = IButtonWindow(find("obj_tab"));
         var_1981 = IWindowContainer(find("tile_grid"));
         var_1980 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1536,onTopTabButton);
         Util.setProcDirectly(var_1537,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_490)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1980;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_63,HabboWindowStyle.const_42,HabboWindowParam.const_75,new Rectangle(0,0,param1.width,66)));
