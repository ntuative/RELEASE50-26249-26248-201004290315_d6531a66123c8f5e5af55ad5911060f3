package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1131:int = -16;
      
      private static const const_797:int = 32;
      
      private static const const_1132:int = 8;
      
      public static const const_490:int = 10;
      ...
      private var var_1360:BitmapData;
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1131,_loc4_.y + const_1130 - _loc5_.height),null,null,true);
      }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_928.getImage(ThumbnailEditorModel.const_57,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_797 / 2);
         return new Point(param1 * const_797 + _loc3_,param2 * const_1132);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_490)
         {
            var_1103[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1103[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_490)
         {
            if(false)
            {
               refreshObj(param1,var_1103[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1360 == null)
         {
            var_1360 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1360,var_1360.rect,new Point(0,0),null,null,true);
      }
   }
}
