package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_508 == null ? 0 : int(var_508.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_345);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_598);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_345,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_508 == null)
         {
            var_508 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_508.procedure = onChangeFilter;
