package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1630:ITextWindow;
      ...
      private var var_1134:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_1131.setText(_loc1_.description);
         var_965.setText("");
         var_1135.setText("");
         ...
         setTag(var_863,_loc1_.tags[0]);
         setTag(var_861,_loc1_.tags[1]);
         if(var_1132)
         {
            if(_loc1_.allowPets)
            {
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_389);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_81.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_389]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_63,HabboWindowStyle.const_42,HabboWindowParam.const_75,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1411.visible = _inRoom;
         var_1409.visible = _inRoom;
         var_1630.visible = var_464;
         var_1629.visible = !var_464;
         if(var_464)
         {
         ...
         else
         {
            ...
            var_964.height = Util.getLowestPoint(this.var_964) + 4;
         }
         var_1410.text = !!var_464 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1411.name,var_1133.name,var_964.name,var_962.name,var_1130.name,var_1409.name],0,0);
      ...
      {
         this.var_389 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_389));
         if(var_966 != null)
         {
            var_966.visible = false;
         }
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1131.getText();
         ...
         {
            _loc8_ = var_965.getText();
            _loc9_ = var_1135.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_965.clearErrors();
               this.var_1135.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = var_1134.isSelected;
         _loc2_.allowWalkThrough = var_1129.isSelected;
         _loc2_.tags = new Array();
         addTag(var_863,_loc2_.tags);
         addTag(var_861,_loc2_.tags);
         this.clearErrors();
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_389));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_389 || var_963 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_963 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1195)
         {
         ...
         {
            this.var_1131.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1233)
         {
            setTagError(this.var_863,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_861,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1343)
         {
            setTagError(this.var_863,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_861,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_650,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_942,onDoorModePasswordUnselect);
         ...
         this.var_1131 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_863 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_861 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_965 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1135 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1132 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1134 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1129 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1411 = IWindowContainer(_window.findChildByName("header_container"));
         var_1133 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_964 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_962 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1409 = IWindowContainer(_window.findChildByName("switch_view_container"));
         ...
         var_966 = IWindowContainer(_window.findChildByName("password_container"));
         var_1629 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1630 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1410 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1410.procedure = onSwitchView;
         var_966.visible = false;
         if(!_inRoom)
         {
