package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_895:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_516 = new Timer(100);
         var_516.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1078 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_516)
         {
            var_516.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_516.reset();
            var_516 = null;
         }
      }
      ...
      {
         var_1078.goBackToInitialState();
         var_1078.input.textBackgroundColor = 4294967295;
         var_895 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_63,HabboWindowStyle.const_42,HabboWindowParam.const_75,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1078.getText();
      ...
      {
         var _loc1_:Boolean = var_1078.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_895.view.findChildByName("select_arrow"));
