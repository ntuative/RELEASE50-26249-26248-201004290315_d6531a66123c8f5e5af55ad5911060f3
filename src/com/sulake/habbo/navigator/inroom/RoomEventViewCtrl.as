package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_862:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_722.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_863.getText());
         addTag(_loc6_,var_861.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1916.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_722.setText(param1.eventDescription);
         var_863.setText(getTagFromEvent(param1,1));
         var_861.setText(getTagFromEvent(param1,2));
         var_1257.visible = false;
         var_1258.visible = true;
         var_1259.visible = true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1916 = ITextWindow(find("event_type_disabled_text"));
            var_1525 = ITextWindow(find("create_caption"));
            var_1523 = ITextWindow(find("edit_caption"));
            var_1257 = IButtonWindow(find("create_button"));
            var_1258 = IButtonWindow(find("edit_button"));
            var_1915 = IButtonWindow(find("cancel_button"));
            var_1259 = IButtonWindow(find("end_button"));
            var_862 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1257,onCreateButtonClick);
            Util.setProcDirectly(var_1258,onEditButtonClick);
            Util.setProcDirectly(var_1259,onEndButtonClick);
            Util.setProcDirectly(var_1915,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_722 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_863 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_861 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_722.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_1257.visible = true;
         var_1258.visible = false;
         var_1259.visible = false;
         var_722.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_863.goBackToInitialState();
         var_861.goBackToInitialState();
         var_862.selection = 0;
