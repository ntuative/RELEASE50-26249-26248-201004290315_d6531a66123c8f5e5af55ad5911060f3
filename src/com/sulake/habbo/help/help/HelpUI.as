package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1439:int = 0;
      ...
      private var var_2041:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26249-26248-201004290240");
         var_199 = param5;
         var_105 = new Map();
         var_105.add(HabboHelpViewEnum.const_1223,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_152,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_460,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_277,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_224,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_718,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_290,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_627,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_206,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_105.add(HabboHelpViewEnum.const_877,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_105.add(HabboHelpViewEnum.const_665,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1547 = 0 - _loc3_.width;
         var_1546 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_274 == HabboHelpViewEnum.const_152 || false)
         {
            return;
         }
         if(var_430 == null)
      ...
      {
         return var_105.getValue(var_274);
      }
      ...
      {
         var_2040 = param1;
         var _loc2_:IHelpViewController = var_105.getValue(HabboHelpViewEnum.const_152) as IHelpViewController;
      ...
      {
         var _loc3_:* = null;
         if(var_274 == HabboHelpViewEnum.const_152)
         {
            return;
         }
         if(true)
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1546;
         _window.width = _loc1_.width + var_1547;
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_380));
      }
