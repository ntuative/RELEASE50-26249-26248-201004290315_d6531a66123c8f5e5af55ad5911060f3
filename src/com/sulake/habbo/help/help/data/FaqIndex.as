package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_658 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_657 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_124 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_658.hasItem(param1))
         {
            var_658.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_657.hasItem(param1))
         {
            var_657.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
