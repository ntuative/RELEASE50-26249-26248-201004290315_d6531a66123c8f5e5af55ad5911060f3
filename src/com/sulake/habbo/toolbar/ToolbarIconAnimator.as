   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_935.push(new XML());
               var_936.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_936[var_53] = param6.clone();
         }
      ...
      {
         if(var_1374 == true || var_771 == 0)
         {
            if(false)
            {
               ++var_53;
               if(var_53 >= var_935.length)
               {
                  var_53 = 0;
                  ++var_771;
               }
      ...
      {
         return var_935.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1374 == false && var_771 == 1 && var_1191 != var_33;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_53 <= var_936.length)
         {
            _loc2_ = var_936[var_53];
