package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1517:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_198 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_63,HabboWindowStyle.const_927,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1047 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1047)
         {
         ...
         var_1246 = _loc7_.toolbar.@margin_bottom;
         var_1517 = _loc7_.toolbar.@min_group_margin;
         var_1518 = _loc7_.toolbar.@margin_to_extrabar;
         var_282 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_268,param1,param2,_window,var_282);
         createGroupsFromXmlList(_loc9_,var_600,param1,param2,var_198,var_282);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_134,var_507,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1517,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1246) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1517,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1246) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_600.length)
         {
            _loc3_ = var_600[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_134,var_507);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_600.length)
         {
            _loc2_ = var_600[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_134,var_507);
         }
      }
