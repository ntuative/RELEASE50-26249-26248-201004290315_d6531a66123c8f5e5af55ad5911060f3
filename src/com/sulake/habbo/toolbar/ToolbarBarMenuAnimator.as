package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_796:int = 50;
      
      private static const const_1066:Number = 25;
      
      private static const const_1120:int = 50;
      ...
      private var var_1093:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1093 = param2;
         var_627 = new Timer(const_1066);
         var_627.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function getWindowByName(param1:String) : IWindow
      {
         ...
         if(_loc2_ == null)
         {
            _loc3_ = _windowManager.method_7(0);
            if(_loc3_ != null)
            {
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_530.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_530.splice(_loc3_,1);
            var_529.splice(_loc3_,1);
         }
         var_529.push(param1.name);
         var_530.push(param2);
         param1.addEventListener(WindowEvent.const_406,windowEventListener);
         param1.addEventListener(WindowEvent.const_226,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_530[var_529.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1093.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_325.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_325.splice(var_325.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1093.getIconLoc(param1.iconId);
      ...
      {
         return var_529[var_530.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_325[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_626[_loc3_] = new Array();
            }
            if(var_626[_loc3_].indexOf(param1) < 0)
            {
               var_626[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_796 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_796 || param1.desktop.height - param1.y < const_1120;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_529.length)
         {
            if(var_529[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_626[_loc3_].length)
                  {
                     repositionWindow(var_626[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
