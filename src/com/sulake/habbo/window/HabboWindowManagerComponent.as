package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_355:uint = 3;
      ...
      private var var_1283:ProfilerAgentTask;
      
      private var var_1281:IEventDispatcher;
      
      private var var_2401:uint = 0;
      
      private var var_1282:ProfilerAgentTask;
      
      private var var_1284:ProfilerOutput;
      
      private var var_735:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1281 = Component(param1).events;
         var_429 = new Array();
      ...
      {
         return var_238[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_238[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_695 = new SkinContainer(_loc3_.content as XML,assets);
         var_735 = new WindowRenderer(var_695);
         var_238 = new Array(const_355);
         var _loc5_:int = 0;
         while(_loc5_ < const_355)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_735,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_238[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_238[const_1102];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_296,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1222,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_238[param2].getDesktopWindow();
      ...
      public function method_7(param1:uint) : IWindowContext
      {
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_238.pop()).dispose();
            }
            var_238 = null;
            while(false)
            {
      ...
      {
         return var_238[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1284 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1284 = new ProfilerOutput(_loc3_,this,var_735);
               var_1283 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1283);
               var_1282 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1282);
               var_1066 = true;
            }
         }
      }
      ...
      {
         return var_695.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return method_7(param2).getWindowParser().parseAndConstruct(param1,null,param3);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_948.length > 0)
         {
            var_1281.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_355 - 1;
            while(_loc2_ >= 0)
            {
               var_238[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1066)
         ...
         var_1281.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_355)
         {
            var_238[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1066)
         {
         ...
         if(WindowContext.var_948.length > 0)
         {
            WindowContext.var_948.flush();
         }
         if(WindowContext.var_1385.length > 0)
         {
            WindowContext.var_1385.flush();
         }
         var_1281.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1172,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1147,new Date().getTime().toString());
