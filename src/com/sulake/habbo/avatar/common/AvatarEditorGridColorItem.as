package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_720:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_683.width,var_683.height,true,0);
            _loc1_.bitmap.copyPixels(var_683,var_683.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_859.width,var_859.height,true,0);
            _loc5_ = var_859.clone();
            _loc5_.colorTransform(_loc5_.rect,var_720.colorTransform);
