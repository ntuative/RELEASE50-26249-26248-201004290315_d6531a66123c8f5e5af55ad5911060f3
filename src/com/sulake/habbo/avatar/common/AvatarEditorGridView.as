   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            ...
            var_432 = new Array();
            var_432.push(_view.findChildByName("palette0") as IItemGridWindow);
            var_432.push(_view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_53)
         {
            ...
            _loc7_ = 0;
            while(_loc7_ < const_1133)
            {
               if(var_432.length > _loc7_)
               {
                  _loc4_ = var_432[_loc7_] as IItemGridWindow;
                  _loc5_ = _loc4_.getGridItemIndex(_loc6_);
                  if(_loc5_ > -1)
                  {
                     _model.selectColor(var_1287,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = _model.getCategoryData(var_1287);
         if(!_loc1_)
         {
            return;
         }
         ...
         _loc3_ = 0;
         while(_loc3_ < const_1133)
         {
            _loc4_ = _loc1_.getPalette(_loc3_);
            _loc5_ = var_432[_loc3_] as IItemGridWindow;
            if(!(!_loc4_ || !_loc5_))
            {
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_53)
         {
            ...
            _model.selectPart(var_1287,_loc3_);
         }
      }
