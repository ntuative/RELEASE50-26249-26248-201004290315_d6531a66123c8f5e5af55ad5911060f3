package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1596 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_2200 = parseInt(_loc2_,16);
         var_2199 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1555 = _rgb >> 16 & 255;
         var_1556 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1554 = var_1555 / 255 * 1;
         var_1553 = var_1556 / 255 * 1;
         var_1552 = _b / 255 * 1;
         if(var_1596 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1554,var_1553,var_1552,_alphaMultiplier);
         var_1099 = generatePaletteMapForGrayscale(var_2199,var_2200);
      }
      
      public function get reds() : Array
      {
         return var_1099.getValue("reds") as Array;
      }
      ...
      {
         return var_1099.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1099.getValue("greens") as Array;
      }
      ...
      {
         return var_1099.getValue("alphas") as Array;
      }
