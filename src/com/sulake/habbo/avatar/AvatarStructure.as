package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_418:PartSetsData;
      
      private var var_1849:PartOffsetData;
      
      private var var_840:AvatarActionManager;
      
      private var var_174:IAssetLibrary;
      
      private var var_1034:IAssetLibrary;
      
      private var var_1850:AvatarRenderManager;
      ...
      private var var_1502:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_418 = new PartSetsData();
         _animationData = new AnimationData();
         var_1502 = new AvatarStructureDownloadSet();
         var_703 = new AnimationManager();
         var_702 = param4;
         var_1849 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_840.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_840.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_311.appendXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_840.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_418.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_418.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1241[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_840.getDefaultActionType();
         var _loc9_:Array = var_418.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_703.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_418.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_418.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_702 + " ready to go!");
         if(var_702 == AvatarType.const_85)
         {
            var_418.getPartDefinition("ri").appendToFigure = true;
            var_418.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_702)
         {
            case AvatarType.const_85:
               ...
               var_1502.add(new AvatarStructureDownload(var_174,_loc5_,var_311));
               break;
            case AvatarType.PET:
         }
         var_1502.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_840 = new AvatarActionManager(var_174,var_702);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1224 = var_311.getMandatorySetTypeIds();
         return var_1224;
      }
      ...
      {
         return var_1849.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      {
         return var_840.sortActions(param1);
      }
   }
}
