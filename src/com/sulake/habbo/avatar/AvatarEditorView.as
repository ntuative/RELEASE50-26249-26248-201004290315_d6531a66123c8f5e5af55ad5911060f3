package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1472:ITabSelectorWindow;
      ...
      private function createWindow() : void
      {
         ...
         var_1472 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_29.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1473 == AvatarEditorSideCategory.WARDROBE || var_1770))
         {
            _loc4_ = "null";
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarEditorSideCategory.const_381:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_381);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_274 = param1;
         var_1472.setSelected(var_1472.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1473 == AvatarEditorSideCategory.WARDROBE)
         {
            var_1770 = false;
            setSideContent(AvatarEditorSideCategory.const_675);
         }
         else
         {
