package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      {
         var _loc2_:ActivePartSet = var_897[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_897[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_897[param1.activePartSet] as ActivePartSet;
      }
