package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1089:String = AvatarSetType.const_40;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String, param6:String = null)
      {
         ...
         if(var_196 == null)
         {
            var_196 = AvatarScaleType.const_56;
         }
         ...
         var_135 = new AvatarImageCache(var_52,this,_assets,var_196);
         setDirection(const_1089,const_1088);
         var_197 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(var_702 == AvatarType.PET && param1 == AvatarSetType.const_50)
         {
            if((var_93 == 6 || var_93 == 0) && param2 == 7)
            {
               param2 = var_93;
            }
            _loc3_ = var_52.renderManager.petDataManager.getPetData(var_1236);
            if(_loc3_ != null)
            {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         var_420 = false;
         var _loc1_:Array = var_52.sortActions(var_197);
         if(_loc1_ == null)
         {
         ...
         {
            var_598 = var_52.getCanvasOffsets(_loc1_,var_196,var_93);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1234 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_741)
            {
               var_420 = true;
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_476)
            {
               var_420 = true;
            }
         }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_52.getCanvas(var_196,var_177.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_52.getBodyParts(param1,var_177.definition,var_93);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_702 == AvatarType.PET)
               {
                  ...
                  _loc18_ = 32;
                  if(var_196 == AvatarScaleType.SMALL)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_52.getPartActionOffset(getSubType(),var_196,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = var_52.getCanvas(var_196,var_177.definition.geometryType);
         if(_image == null || _loc4_ != null && (_image.width != _loc4_.width || _image.height != _loc4_.height))
         {
            _loc4_ = var_52.getCanvas(var_196,var_177.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               if(var_702 == AvatarType.PET)
               {
                  ...
                  if(_loc15_.length > 0)
                  {
                     ...
                     _loc22_ = var_52.getPartActionOffset(getSubType(),var_196,_loc8_,_loc14_,_loc19_,_loc20_);
                     if(_loc22_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_177 = new ActiveActionData(AvatarAction.const_916);
         var_177.definition = var_52.getActionDefinition(const_1090);
      ...
      {
         return var_52.getBodyPartData(param1.animation.id,var_504,param1.id);
      }
