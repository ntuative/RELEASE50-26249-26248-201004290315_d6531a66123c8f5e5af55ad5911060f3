package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1041:PaletteManager;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_85:
               _loc3_ = var_232.getValue(AvatarType.const_85) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_232.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_232.getValue(AvatarType.const_85) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_232.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_1041 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_232.add(AvatarType.const_85,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_232.add(AvatarType.PET,_loc5_);
      }
      ...
      {
         var_652 = param1;
         if(var_652 == RenderMode.const_1228)
         {
            init();
         }
         if(var_652 == RenderMode.const_1381)
         {
            init();
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         var _loc6_:AvatarStructure = var_232.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_232.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:AvatarStructure = var_232.getValue(AvatarType.const_85) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
