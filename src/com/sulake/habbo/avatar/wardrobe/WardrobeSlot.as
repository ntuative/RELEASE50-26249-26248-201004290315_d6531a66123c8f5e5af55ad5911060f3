package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit
   {
      ...
      public function updateView() : void
      {
         ...
         if(var_313 && var_1368)
         {
            _loc5_ = var_29.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.SMALL,var_635);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_40,parseInt(FigureData.const_735));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               var_635 = var_29.gender;
               var_29.handler.saveWardrobeOutfit(var_1602,this);
               updateView();
               break;
            case "get_button":
               if(var_313)
               {
                  var_29.loadAvatarInEditor(var_313,var_635,var_29.clubMemberLevel);
               }
         }
      }
   }
