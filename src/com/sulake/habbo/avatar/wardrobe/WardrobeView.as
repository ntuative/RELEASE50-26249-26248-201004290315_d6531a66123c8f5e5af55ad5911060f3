package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_676:IItemListWindow;
      
      private var _model:WardrobeModel;
      
      private var _window:IWindowContainer;
      
      private var var_1003:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_676 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1003 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_676)
         {
            var_676.removeListItems();
         }
         if(var_1003)
         {
            var_1003.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_676)
               {
                  var_676.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1003)
            {
               var_1003.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
