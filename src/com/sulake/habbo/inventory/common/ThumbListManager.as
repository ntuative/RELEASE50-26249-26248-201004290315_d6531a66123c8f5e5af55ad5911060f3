package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1032:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_92 = var_593.height;
         var_1033 = param5;
         var_839 = param6;
         var_230 = Math.floor(var_1033 / _thumbWidth);
         var_18 = new BitmapData(var_1033,var_839);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_18.height < var_839)
         {
            _loc12_ = new BitmapData(var_18.width,var_839);
      ...
      private function getList() : Array
      {
         ...
         if(var_1032 != null)
         {
            _loc1_ = var_1032.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_500 = resolveRowCountFromList();
         if(var_500 == 0)
         {
            var_18 = new BitmapData(var_1033,var_839);
            return;
         }
         var_18 = new BitmapData(Math.max(var_230 * _thumbWidth,var_1033),Math.max(var_500 * var_92,var_839),true,16777215);
         var_18.fillRect(var_18.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_500)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_230 && var_18.height < _loc3_.y * var_92)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_230 - 1),var_92);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_230 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_92),null,null,true);
         _loc4_ = new Rectangle(0,var_92,_thumbWidth * (var_230 - 1),0 - var_92);
