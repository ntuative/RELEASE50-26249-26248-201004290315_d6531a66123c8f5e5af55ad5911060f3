package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1639:int = 13421772;
      ...
      protected var var_2291:BitmapData;
      ...
      private const const_1640:int = 8947848;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_564)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1543));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1395);
         }
         if(_loc1_.id > 0)
         {
      ...
      public function method_1(param1:int) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < _items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1394 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2291;
               _loc5_.visible = true;
            }
            else
            {
