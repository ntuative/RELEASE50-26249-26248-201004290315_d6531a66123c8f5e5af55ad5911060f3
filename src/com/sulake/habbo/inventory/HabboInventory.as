package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_891:IRoomSession;
      ...
      private const const_1652:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_386,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_105:
               var_891 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_386:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_658));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_46.getValue(InventoryCategory.const_79));
      }
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_150));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_924));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1652);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_300));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_890.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_890.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return var_46.getValue(InventoryCategory.const_303) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_256));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_386,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_303,_loc3_);
         ...
         var_46.add(InventoryCategory.const_300,_loc7_);
         ...
         var_46.add(InventoryCategory.const_150,_loc10_);
         _communication.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(method_10));
      }
