package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_864:Boolean = true;
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_723 == InventoryCategory.const_150)
            {
               toggleCategoryView(InventoryCategory.const_150);
            }
            else if(var_723 == InventoryCategory.const_79)
            {
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_199 != null)
         {
            var_199.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_714,HabboToolbarIconEnum.INVENTORY,var_14 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_29.inventoryViewOpened(var_724);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_723 || !var_29.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_199 != null && var_864)
