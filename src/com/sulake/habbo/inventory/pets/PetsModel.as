package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1209 && param1.type == RoomEngineObjectEvent.const_225)
         {
            var_29.showView();
            var_1209 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1209 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_39,RoomObjectTypeEnum.const_333,_loc3_.figure);
            var_29.closeView();
            return;
         }
      ...
      {
         if(var_973.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
