package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1388:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_528 = false;
         var_761 = false;
         var_47.updateItemList(var_760);
         var_47.updateItemList(var_1338);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_47.alertPopup(TradingView.const_875);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_760)
            {
               var_528 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_761 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_47.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_760)
            {
               var_47.alertPopup(TradingView.const_894);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_33 + " NEW STATE: " + param1 + " OWN: " + var_528 + " OTHER: " + var_761);
         ...
         {
            case const_182:
               if(param1 == const_167 || param1 == const_220)
               {
                  var_33 = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_244.length)
         {
            _loc2_ = var_244.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(var_244.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_620)
         {
            if(var_33 != const_182 && var_33 != const_220)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_182;
            var_11.toggleInventorySubPage(InventorySubCategory.const_840);
            var_620 = false;
         }
         var_47.setMinimized(false);
      }
