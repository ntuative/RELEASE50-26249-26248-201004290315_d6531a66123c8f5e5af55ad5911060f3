package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_798 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_799 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         var_50 = IItemListWindow(var_53.findChildByName("chatline_list"));
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_798.clone());
      ...
      {
         if(param1.type != WindowEvent.const_47 || param2 != var_53)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_799.clone());
         _loc4_.color = var_1150[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
