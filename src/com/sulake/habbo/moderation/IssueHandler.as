package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_453:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_453 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_1108 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_453.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_120.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1108.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_931,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_453 = new UserInfoCtrl(_window,var_61,_loc3_.message);
            var_453.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
