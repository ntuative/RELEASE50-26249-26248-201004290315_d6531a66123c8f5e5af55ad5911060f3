package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2406:BitmapData;
      
      private var var_2407:BitmapData;
      
      private var var_569:IssueBrowser;
      
      private var var_1600:IWindowContainer;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_50 = param3;
         var_1381 = param4;
         var_1600 = var_569.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1600 == null)
            {
               return;
            }
            _loc2_ = var_1600.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
