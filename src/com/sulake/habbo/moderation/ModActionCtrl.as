package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_922:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_922 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModBanMessageComposer(var_1355,var_446.text,getBanLength(),var_1354));
         this.dispose();
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1355,var_446.text,var_1354));
         this.dispose();
      }
      ...
      {
         return WindowTracker.const_1382;
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1355,var_446.text,var_1354));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this.refreshButtons("offences_cont",2,var_766.offences,var_923,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_922,onOffenceCtgButton);
      ...
      public function show() : void
      {
         ...
         var_53.caption = "Mod action on: " + var_1434;
         ...
         var_924 = IDropMenuWindow(var_53.findChildByName("banLengthSelect"));
