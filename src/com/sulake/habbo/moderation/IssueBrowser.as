package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1450:IIssueBrowserView;
      
      private const const_1642:String = "open_issues";
      ...
      private const const_1641:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_224:ITabContextWindow;
      
      private var var_1451:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_224 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_224.numTabItems)
            {
               _loc5_ = var_224.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_224.selector.getSelectableByName("open_issues");
         var_224.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_342.view.width = var_224.container.width;
         var_342.view.height = var_224.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1641:
               if(var_1449 == null)
               {
                  var_1449 = new MyIssuesView(issueManager,this,var_224.container);
               }
               return var_1449;
            case const_1642:
               if(var_1450 == null)
               {
                  var_1450 = new OpenIssuesView(issueManager,this,var_224.container);
               }
               return var_1450;
            case const_1643:
               if(var_1451 == null)
               {
                  var_1451 = new PickedIssuesView(issueManager,this,var_224.container);
               }
               return var_1451;
            default:
               return null;
