package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_773:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_657,_data.flatId),var_53,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_389);
         if(param1.flatId != var_389)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_389);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_773.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1344,_loc2_,var_446.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1110.isSelected,var_1109.isSelected,var_773.isSelected));
         }
         this.dispose();
      }
      ...
      {
         var_50 = IItemListWindow(var_53.findChildByName("list_cont"));
         ...
         var_773 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1110 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1109 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_389));
         Logger.log("BEGINNING TO SHOW: " + var_389);
      }
   }
}
