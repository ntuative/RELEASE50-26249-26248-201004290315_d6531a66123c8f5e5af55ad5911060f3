package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2145.clone());
      ...
      {
         var_2145 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_50 = IItemListWindow(var_53.findChildByName("visits_list"));
