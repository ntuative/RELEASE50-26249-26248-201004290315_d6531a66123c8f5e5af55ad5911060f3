package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1147 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1147 = 15;
         }
         var_1427 = _window.height;
         var_564 = 4;
         var_399 = 0;
         var_33 = const_348;
         var_199 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1147;
         if(_window.height < var_1427)
         {
            _window.height = var_1427;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_33)
         {
            ...
            case const_396:
               var_790 += param1;
               _loc2_ = Number(var_790) / Number(var_398["time_fade_in"]);
               if(var_790 > int(var_398["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_755:
               var_985 += param1;
               if(var_985 > int(var_398["time_display"]) && !var_1148)
               {
                  startFadeOut();
               }
               break;
            case const_754:
               var_789 += param1;
               _loc3_ = 1 - Number(var_789) / Number(var_398["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_789 > int(var_398["time_fade_in"]))
               {
                  startIdling();
               }
         }
