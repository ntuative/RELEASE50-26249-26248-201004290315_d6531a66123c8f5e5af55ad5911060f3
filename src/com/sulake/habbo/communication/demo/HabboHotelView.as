package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_605:Function;
      
      private var _window:IWindowContainer;
      
      private var var_731:IAssetLibrary;
      
      private var var_870:uint = 0;
      
      private var var_604:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_731.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = var_731.loadAssetFromFile("hotel_view_banner_" + var_870,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_660));
            }
            var_604 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_731.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
