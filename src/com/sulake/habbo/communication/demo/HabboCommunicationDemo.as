package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1859:PseudoRandom;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1276:
            case DisconnectReasonEvent.const_1325:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1367:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1860)
         {
      ...
      {
         var_1035 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_233);
         param1.send(new VersionCheckMessageComposer(401,var_1228,var_1861));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1859);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1228 = _habboConfiguration.getKey("flash.client.url","");
         var_1861 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_175 == null)
         {
         ...
         if(var_708 != null)
         {
            var_59.mode = HabboConnectionType.const_473;
            var_59.initConnection(HabboConnectionType.const_249);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_550);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1859 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_59.mode)
         {
            case HabboConnectionType.const_473:
               ...
               var_1036 = _loc4_;
               var_175.loadBannerImage(_loc7_ + "?token=" + var_1036,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_832:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1225:
               var_596 = generateRandomHexString(30);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1036);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_59.mode = HabboConnectionType.const_832;
            }
         }
         var_59.initConnection(HabboConnectionType.const_249);
      }
