package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_567:String = "InitConnection";
      ...
      private var var_242:HabboCommunicationDemo;
      ...
      {
         var_242.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_242.shockwaveClientUrl = var_116.shockwaveClientUrl;
         var_242.ssoTicket = var_116.ticket;
         var_116.removeEventListener(SSOTicket.const_343,onParsedTicketSuccess);
         var_116.removeEventListener(SSOTicket.const_271,onParsedTicketFailure);
         var_116 = null;
         dispatchEvent(new Event(const_567));
      }
      ...
      {
         var _loc1_:XmlAsset = (var_242 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_242.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_437,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_242.windowManager.buildFromXML(_loc2_) as IWindowContainer;
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_242.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_242.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_242.habboCommunication.habboWebLogin(name,password);
         var_116 = new SSOTicket(var_242.assets,_loc2_,_loc1_);
         var_116.addEventListener(SSOTicket.const_343,onParsedTicketSuccess);
         var_116.addEventListener(SSOTicket.const_271,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_242.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_242.windowManager.buildFromXML(_loc3_.content as XML);
