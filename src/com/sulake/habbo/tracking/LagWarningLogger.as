package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1319 || var_1464 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1465 == 0 || _loc1_ - var_1465 > var_1464)
         {
            if(_connection != null)
            {
      ...
      {
         var_1319 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1464 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
