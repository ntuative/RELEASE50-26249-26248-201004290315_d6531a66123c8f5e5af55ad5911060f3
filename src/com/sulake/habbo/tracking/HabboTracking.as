package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_758:uint = 11;
       
      
      private var var_222:LatencyTracker = null;
      ...
      private var var_149:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1001:int = -1;
      
      private var var_811:LagWarningLogger = null;
      
      private var var_812:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_222 = new LatencyTracker();
         var_811 = new LagWarningLogger();
         var_1167 = new Array(const_758);
         var _loc4_:int = 0;
         while(_loc4_ < const_758)
         {
            var_1167[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1199,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1214,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_612,String(false));
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_222 != null)
            {
               var_222.communication = _communication;
               var_222.connection = param1;
            }
            if(var_811 != null)
            {
               var_811.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_292:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_150)
         {
            Component(var_150).events.addEventListener(HabboConfigurationEvent.const_173,onConfigurationLoaded);
            if(var_222 != null)
            {
               var_222.configuration = var_150;
            }
            if(var_223 != null)
            {
               var_223.configuration = var_150;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_276.events.addEventListener(AdEvent.const_364,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_612,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_550,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_233,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_660,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_457:
               var_811.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_812)
            {
               var_812.release(new IIDHabboWindowManager());
               var_812 = null;
            }
            if(var_276)
            {
            ...
            if(var_167)
            {
               if(true)
               {
                  ...
                  Component(var_167).events.removeEventListener(HabboFriendListTrackingEvent.const_292,onFriendlistTrackingEvent);
               }
            ...
            if(var_149)
            {
               if(true)
               {
                  var_149.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_149.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_149.release(new IIDHabboHelp());
               var_149 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_457,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_150)
         {
            if(var_811 != null)
            {
               var_811.configure(var_150);
            }
            Component(var_150).events.removeEventListener(HabboConfigurationEvent.const_173,onConfigurationLoaded);
         }
      }
      ...
      {
         var_149 = param2 as IHabboHelp;
         var_149.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_149.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_816);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_816,onCoreRunning);
         }
      }
      ...
      {
         var_812 = IHabboWindowManager(param2);
         if(var_812)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1444;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1444);
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_457,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_279,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_167).events.addEventListener(HabboFriendListTrackingEvent.const_292,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         {
            _crashed = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_22,new Date().getTime().toString());
            if(var_150)
            {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_660)
         {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1151);
         }
      }
   }
}
