package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1585)
         {
            case RecyclerStatusMessageEvent.const_1346:
               ...
               break;
            case RecyclerStatusMessageEvent.const_913:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1585 != RecyclerStatusMessageEvent.const_913;
      }
      
      private function get statusActive() : Boolean
      {
         return var_283 != const_790;
      }
      ...
      {
         return active && var_283 == const_357;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_860:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1150:
