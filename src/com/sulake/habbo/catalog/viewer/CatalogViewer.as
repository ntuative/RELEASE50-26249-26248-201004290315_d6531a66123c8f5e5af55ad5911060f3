package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1413:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_440 != null)
         {
            if(var_440.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_440.window);
            var_440.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1413);
         var_440 = _loc5_;
      ...
      {
         return var_440.dispatchWidgetEvent(param1);
      }
