package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_975 != null)
         {
            var_975.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_976 != null)
         {
            var_976.removeEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_975 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_975 != null)
         {
            var_975.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_976 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_976 != null)
         {
            var_976.addEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         }
      }
