package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1188:String = "default";
      ...
      private var var_1187:String = "1.1";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_272 != null && var_269 != null)
         {
            setRoomImage(var_272,var_269);
         }
      }
         ...
         switch(param1)
         {
            case const_188:
               ...
               for each(_loc8_ in var_150.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_717 = _loc8_.children().length();
                  }
               }
            ...
            case const_190:
               ...
               for each(_loc9_ in var_150.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_718 = _loc9_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1188,var_1187,64,this,"window_romantic_wide");
