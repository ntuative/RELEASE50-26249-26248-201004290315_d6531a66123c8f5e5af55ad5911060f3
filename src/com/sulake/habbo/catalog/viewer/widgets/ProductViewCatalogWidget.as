package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1499:Point;
      
      private var var_1842:Array;
      
      private var var_591:IItemGridWindow;
      
      private var var_82:IBitmapWrapperWindow;
      
      private var var_1370:ITextWindow;
      
      private var var_1219:IScrollbarWindow;
      
      protected var var_1349:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_591 != null)
         {
            var_591.visible = false;
            var_591.destroyGridItems();
         }
         if(var_1219 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1370.text = "${" + _loc3_.name + "}";
            var_1371.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1370.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_450:
                  _loc4_ = var_1220.clone();
                  if(var_591 != null)
                  {
                     var_591.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_591,var_1219,var_1349);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_209:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_327,AvatarAction.const_639);
                              _loc13_.appendAction(AvatarAction.const_689,_loc6_.productClassId);
      ...
      {
         var_1370 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1371 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1499 = new Point(var_82.x,var_82.y);
         var_591 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1219 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_591 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1349 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1220 = _loc2_.content as BitmapData;
