package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_606.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      {
         if(!param1 || !param2 || !var_606 || !var_29)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_606.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
