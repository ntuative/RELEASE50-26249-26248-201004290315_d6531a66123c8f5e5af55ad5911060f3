package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_417 >= var_310.length)
         {
            return "";
         }
         var petColor:IPetColor = var_310[var_417] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_592[var_1500] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_417 < 0 || var_417 > var_310.length)
         {
            var_417 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_606.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_111,onTextWindowEvent);
         var_606 = new Map();
         ...
         var_838 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_310 = [];
         var_592 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_838);
               if(_loc11_)
               {
                  var_592 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_592.length)
         {
            _loc12_ = var_592[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_838,_loc12_.id),getRaceLocalizationKey(var_838,_loc12_.id)));
            _loc6_++;
         }
         var_606.add(var_838,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_944,onApproveNameResult);
         _loc5_ = var_606.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_606.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_417 >= 0 && var_417 < var_310.length)
         {
            _loc7_ = var_310[var_417] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_592[var_1500] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_838,_loc3_.id,_loc2_,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_327,AvatarAction.const_648);
