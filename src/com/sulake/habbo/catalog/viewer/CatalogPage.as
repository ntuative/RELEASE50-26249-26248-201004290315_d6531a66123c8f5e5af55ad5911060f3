package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1218:EventDispatcher;
      
      private var _pageId:int;
      
      private var var_917:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1393 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1393) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_837);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1218;
            _loc2_.init();
         }
         var_1218.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1218.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_837);
      }
