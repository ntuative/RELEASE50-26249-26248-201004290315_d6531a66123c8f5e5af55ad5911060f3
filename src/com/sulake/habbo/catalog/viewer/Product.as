package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1139:IProductData;
      ...
      {
         super();
         var_1138 = param1.productType;
         var_1141 = param1.furniClassId;
         var_969 = param1.extraParam;
         var_968 = param1.productCount;
         var_1140 = param1.expiration;
         var_1139 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_86:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_969);
               break;
