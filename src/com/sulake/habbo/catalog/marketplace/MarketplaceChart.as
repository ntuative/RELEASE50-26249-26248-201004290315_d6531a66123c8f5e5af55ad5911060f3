package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1058 + var_1058 / -var_2373 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_868 - var_868 / var_424 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc3_.draw(_loc6_);
         var_1058 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(var_1058 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1058,(param2 - var_868) / 2));
         return _loc3_;
      }
