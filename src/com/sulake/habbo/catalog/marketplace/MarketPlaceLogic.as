package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2052:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1525,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1913 || param1.furniTypeId != var_1912)
         {
            return;
         }
         var_2052 = param1;
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = var_201.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1549,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_201.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_201.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_376)
            {
               var_201.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1666 = _loc3_.creditsWaiting;
         var_201 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_201.add(_loc4_.offerId,_loc6_);
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_208)
         {
            var_208 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_208.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_2053,var_2050,var_2051,var_2054);
      }
