package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         _window = var_440.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         if(!var_440 || true || !var_440.viewer.catalog || !var_440.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = var_440.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:ClubBuyController = (var_440.viewer.catalog as HabboCatalog).getClubBuyController();
         (var_440.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_79,var_440);
      }
   }
}
