package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1441:uint = 4.294967295E9;
      
      private const const_1442:uint = 4.293848814E9;
      
      private var var_920:int;
      
      private const const_1665:uint = 4.291613146E9;
      ...
      private const const_1666:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_246.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1442) : uint(const_1441);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_440,var_79,var_1100);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_246.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_631[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_630[var_207]);
         _catalog.purchaseProductAsGift(var_440,var_79,var_1100,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_111:
               ...
               if(var_2212 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_235)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1666)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2212 = _loc3_.text;
               break;
            case WindowMouseEvent.const_53:
               showSuggestions(false);
               if(var_1352)
               ...
               break;
            case WindowKeyboardEvent.const_716:
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_209:
                  ...
                  break;
               case ProductTypeEnum.const_287:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_631 = _loc1_.boxTypes;
            var_630 = _loc1_.ribbonTypes;
            var_921 = var_1407[0];
            _boxIndex = var_631[0];
            var_207 = var_630[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_246.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_246 == null)
         {
            var_246 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_532 == null)
         {
            var_532 = createWindow("suggestion_list_item") as IWindowContainer;
            var_532.procedure = suggestionsEventHandler;
         }
         if(var_246 == null || var_532 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_246.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_532.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
