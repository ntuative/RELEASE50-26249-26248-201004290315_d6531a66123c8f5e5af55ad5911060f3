package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1071:UserDataManager;
      ...
      {
         if(var_33 == RoomSessionEvent.const_302 && _connection != null)
         {
      ...
      {
         return var_1071 as IUserDataManager;
      }
