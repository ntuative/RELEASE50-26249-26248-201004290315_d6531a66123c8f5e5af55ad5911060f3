package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_501:int = 16;
      
      private static const const_1124:int = 20;
      
      private static const const_353:int = 10;
      
      private static const const_1125:int = 40;
      ...
      private var var_438:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1101 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2219 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2220 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_768 = new Timer(1000,1);
         var_768.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_925 = new Timer(5000,1);
         var_925.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_63,HabboWindowStyle.const_43,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_111,onInputChanged);
         _window.addEventListener(WindowEvent.const_406,onWindowMoved);
         var_1357 = true;
         var_143 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2218 = _loc2_.width + const_501 + _loc6_.width + const_1124;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1125,_loc8_.width) + const_501);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1101 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_143 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_438);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_438);
         }
