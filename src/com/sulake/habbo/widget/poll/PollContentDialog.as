package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_715[var_1049] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_315)
         {
            ...
            var_315 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_315.center();
            var_315.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1049;
         if(var_1049 < var_715.length)
         {
            _loc1_ = var_715[var_1049] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_715.length);
                  _loc2_.text = _loc6_;
               }
