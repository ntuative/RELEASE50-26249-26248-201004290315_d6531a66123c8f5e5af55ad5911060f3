package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      private function showPollOffer(param1:Event) : void
      {
         ...
         var _loc3_:PollSession = var_287.getValue(_loc2_) as PollSession;
      ...
      {
         var _loc2_:PollSession = var_287.getValue(param1) as PollSession;
         if(_loc2_)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
            var_287.remove(param1);
         }
      }
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = var_287.getValue(_loc3_) as PollSession;
            if(_loc4_)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_287)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_287.getWithIndex(0) as PollSession;
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
