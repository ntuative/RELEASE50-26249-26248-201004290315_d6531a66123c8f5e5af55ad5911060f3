package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_101 && param1.type != WindowMouseEvent.const_418)
         {
            return;
         }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_557 != null)
            {
               ...
               var_1412 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1412 * (Number(param1 - var_653) / (var_970 - var_653)));
      }
      ...
      {
         return int(param1 / var_1412 * (var_970 - var_653)) + var_653;
      }
   }
}
