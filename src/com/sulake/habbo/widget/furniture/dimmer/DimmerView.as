package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_469:DimmerViewColorGrid;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_224.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_224.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_63,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1041,const_1040,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_469 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         ...
         var_224 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_224.numTabItems)
         {
            _loc6_ = var_224.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_469 != null)
         {
            var_469.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_224.selector.getSelected();
         return var_224.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_977 = _loc2_.light;
         if(var_339 != null)
         {
            var_339.setValue(var_977);
         }
         var_417 = colors.indexOf(_loc2_.color);
         if(var_469 != null)
         {
            var_469.setSelectedColorIndex(var_417);
         }
