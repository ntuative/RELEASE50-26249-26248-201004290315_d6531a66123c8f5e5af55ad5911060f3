package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1664:uint = 6710886;
      ...
      private const const_1656:String = "energy";
      
      private var var_1197:Map;
      
      private const const_1662:String = "nutrition";
      
      private var var_62:IItemListWindow;
      
      private const const_1660:uint = 3355443;
      ...
      private const const_1661:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_220 != null)
         {
            var_101 = var_220.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_101 == null || var_220 == null || var_62 == null)
         {
            return;
         }
         ...
         var_220.height = NaN;
         _window.width = Math.max(var_220.width,var_62.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1197.getValue(var_623) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1661,param1.experience,param1.experienceMax);
         updateStateElement(const_1656,param1.energy,param1.energyMax);
         updateStateElement(const_1662,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_623 = param1.id;
         var_1197.remove(param1.id);
         var_1197.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_182 && var_182.getPetId() == var_623)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_439,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1658,const_1663,false);
