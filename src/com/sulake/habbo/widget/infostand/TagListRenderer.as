package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1245 != null && var_1245.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_854 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_854 += param1.height + const_1647;
            return fit(param1);
         }
         param1.offset(_offsetX,var_854);
         _offsetX += param1.width + const_1648;
         return true;
      }
