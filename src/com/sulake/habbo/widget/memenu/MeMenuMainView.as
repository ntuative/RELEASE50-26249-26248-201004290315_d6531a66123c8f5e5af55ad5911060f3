      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_583);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_837));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_305);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_951));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_672);
               break;
            case "news":
               if(false && false)
               {
