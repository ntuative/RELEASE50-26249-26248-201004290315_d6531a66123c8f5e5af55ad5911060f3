package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_501:int = 6;
      
      private static const const_353:int = 10;
      
      private static const const_1083:Number = 18;
      
      private static const const_1429:Number = 10;
      
      private static const const_1428:Number = 8;
       
      
      private var var_1215:Number;
      ...
      {
         _widget.onItemMouseOut(var_1029,var_1031,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1029,var_697,var_1031,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1217 = param1.chatType;
         var_1029 = param1.userId;
         var_697 = param1.userName;
         var_1031 = param1.userCategory;
         _message = param1.text;
         var_1215 = param1.userX;
         var_195 = param1.userImage;
         var_1030 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1030 != 0)
            {
               _loc30_ = uint(var_1030 >> 16 & 255);
               _loc31_ = uint(var_1030 >> 8 & 255);
               _loc32_ = uint(var_1030 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1217 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_697);
            }
            else if(var_1217 == RoomWidgetChatUpdateEvent.const_259)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_697);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_416;
            _loc20_.width = _loc20_.textWidth + const_501;
            _width += _loc20_.textWidth + const_501;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_353 + _loc20_.textWidth + const_501;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1029,var_1031,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1029,var_1031,_roomId,_roomCategory,param1);
      }
