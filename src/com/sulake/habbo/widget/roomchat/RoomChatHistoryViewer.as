package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_155.state = RoomChatHistoryPulldown.const_237;
         ...
         var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_978,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_236 > 0 && param2)
         {
            if(var_1276)
            {
               if(Math.abs(param1 - var_236) <= const_851)
               {
                  return;
               }
               var_1276 = false;
            ...
            if(var_320)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_43.scrollV < 1 - const_1101 / var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1544)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_320 && !var_1206)
         {
            ...
            var_155.state = RoomChatHistoryPulldown.const_310;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_155.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_237);
      }
