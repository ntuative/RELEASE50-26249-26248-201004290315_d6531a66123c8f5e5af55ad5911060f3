package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_750:int = -2;
      ...
      private static const const_751:String = "overlay";
      ...
      private var var_452:IRoomObjectVisualizationFactory = null;
      
      private var var_471:Boolean = false;
      ...
      private var var_661:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         queueInterface(new IIDHabboConfigurationManager(),method_8);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_111,var_110,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_652) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_616) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_571) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_610) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_143);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_65.modifyWallItemData(var_111,var_110,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_452 != null)
         {
            var_452.release(new IIDRoomObjectVisualizationFactory());
            var_452 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_661 != null)
         {
            var_661.release(new IIDRoomRendererFactory());
            var_661 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_661.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_921;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_586);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_662);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_802);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_845);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               ...
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1021);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_720,var_111,var_110,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_111,var_110,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_299.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_299.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_705,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_697,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_544,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_111,var_110);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_308,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_326,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_895,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_842,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_246,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_622,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_28 == null || var_452 == null || var_41 == null || var_661 == null || _communication == null || _habboConfiguration == null || !var_1636)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_282,RoomObjectCategoryEnum.const_68);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1160,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_111,var_110));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_752,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_110,var_1145);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_110,var_1145);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_452 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_452;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_239,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_445,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_262,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_664,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_114,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_109,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_117,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_94,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_409,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_408,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_449,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_385,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_427,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_459,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectMoveEvent.const_441,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_415,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_279,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_472,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_322,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_291,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_398,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_815,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_389,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_457,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_111,var_110,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_471 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_588,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_299.length)
            {
               _loc3_ = var_299.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_246,param1,param2,param3,RoomObjectCategoryEnum.const_39));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_438);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_704)
         {
            var_1636 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_308,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_326,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_921,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_246,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_276.events.addEventListener(AdEvent.const_364,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_751) as Sprite;
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_661 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_471 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_493);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_493,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_562.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_438,param8);
               break;
            case RoomObjectCategoryEnum.const_39:
            ...
            case RoomObjectCategoryEnum.const_68:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_275,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_542,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
         ...
         {
            var_979.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_883,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_562.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_750,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_110,param1);
         if(_loc9_ != null)
         {
            var_1145 = param1;
            var_1420 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1420 - _loc12_.width / 2;
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_430,var_111,var_110,-1,RoomObjectCategoryEnum.const_204));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_282,const_492);
                  var_65.handleRoomObjectEvent(_loc14_,var_111,var_110);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_111,var_110,param1,param2,new Vector3d(),1,null);
         }
         else if(var_12 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_111,var_110,var_1145);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1420 - _loc6_.data.width / 2;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_309,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1003,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_803,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_866,RoomObjectVariableEnum.const_309,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_704,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_111,var_110);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_493);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_883);
               ...
               _loc13_ = var_979.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_111,var_110,const_282,RoomObjectCategoryEnum.const_68,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_991,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_804,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_282,const_492,_loc8_) as IRoomObjectController;
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_652,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_571,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_616,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_610,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_705,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_697,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_544,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_414,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_238);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_586,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_662,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_586,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_662,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_802,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_845,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_750,const_1042,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         _loc7_.createRoomObject(const_752,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
         return _loc7_;
      }
