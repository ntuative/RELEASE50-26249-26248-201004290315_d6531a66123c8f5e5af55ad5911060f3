package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_768:String = "tile_cursor";
      
      private static const const_285:String = "RCL_PUBLICROOM_";
      
      private static const const_499:String = "wall_place_holder";
      
      private static const STATE_READY:int = 2;
      
      private static const const_352:String = "place_holder";
      
      private static const const_1071:String = const_352;
      ...
      public static const const_704:String = "RCL_LOADER_READY";
      ...
      private var var_1021:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_496 = [];
         var_495 = [];
         var_1799 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1793 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_413 = new Map();
         _events = new Map();
      ...
      {
         if(var_171 != null && var_171.hasWorldType(const_285 + param1))
         {
            return var_171.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_413 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_413.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_413.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_413.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_352,const_499,ROOM_CONTENT,const_768,const_770];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1799.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_185 && _loc5_ != RoomObjectLogicEnum.const_116)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_494.getValue(param1) as String;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1194);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1793.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function continueInitilization() : void
      {
         if(var_1798)
         {
            ...
            if(var_1021 != null)
            {
               var_1021.dispatchEvent(new Event(const_704));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_171 != null)
         {
            return var_171.getWorldHeightScale(const_285 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1021 = param1;
            var_1795 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1794 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1797 = param2.getKey("public.room.dynamic.download.url","");
            var_1796 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_33 = const_769;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_185 && _loc5_ != RoomObjectVisualizationEnum.const_116)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_452.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_285 + param1) == RoomObjectCategoryEnum.const_68)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_471,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_171 != null)
         {
            return var_171.getWorldScale(const_285 + param1);
         }
         return 32;
      }
