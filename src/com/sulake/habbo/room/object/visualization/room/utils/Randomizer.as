package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1597:int = 16777216;
      ...
      private var var_1126:int = 1;
      
      private var var_2365:int = 5;
      
      private var var_1404:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1404 * param2);
      }
      ...
      {
         var _loc1_:int = var_2364 * var_1126 + var_2365;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
