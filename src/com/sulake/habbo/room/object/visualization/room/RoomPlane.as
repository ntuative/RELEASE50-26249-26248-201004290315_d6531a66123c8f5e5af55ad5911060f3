package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_740:IPlaneRasterizer = null;
      
      private var var_823:Vector3d = null;
      ...
      private var var_567:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_2098 = param8;
         var_823 = new Vector3d();
         var_823.assign(param1);
         var_70 = new Vector3d();
         ...
         var_490 = Vector3d.crossProduct(var_263,var_262);
         if(false)
         {
            var_490.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      public function method_11(param1:String, param2:Number, param3:Number) : Boolean
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(var_893)
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_228 || _type == const_189))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_893 || false && false && !var_158 || var_567 == null)
         {
            return;
         }
         ...
         if(var_158)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_490);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_205.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_567.updateMask(var_60,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_741.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_278.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1074.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_158 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_740 != null)
         {
            return var_740.getTextureIdentifier(param1,normal);
         }
      ...
      {
         if(var_130 == null || var_104 == null || var_78 == null || var_103 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_228 || _type == const_189)
         {
      ...
      {
         var_130.assign(param1.getScreenPosition(var_70));
         var_104.assign(param1.getScreenPosition(Vector3d.sum(var_70,var_262)));
         var_78.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_70,var_263),var_262)));
         var_103.assign(param1.getScreenPosition(Vector3d.sum(var_70,var_263)));
         _offset = param1.getScreenPoint(var_823);
         ...
         var _loc2_:Number = Math.min(var_130.x,var_104.x,var_78.x,var_103.x);
         var _loc3_:Number = Math.max(var_130.x,var_104.x,var_78.x,var_103.x);
         var _loc4_:Number = Math.min(var_130.y,var_104.y,var_78.y,var_103.y);
         var _loc5_:Number = Math.max(var_130.y,var_104.y,var_78.y,var_103.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_130.x = 0 - _loc2_;
         var_104.x = 0 - _loc2_;
         ...
         if(true)
         {
            while(_loc1_ < var_205.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = var_741[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1299.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1299[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_823);
            _loc7_ = _loc6_.z;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         updateMaskChangeStatus();
         if(_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_158)
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_490);
            _loc4_ = getTextureIdentifier(param1.scale);
            if(var_240 != null)
            {
               _loc3_ = var_240;
            ...
            if(var_740 != null)
            {
               _loc3_ = var_740.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1560,var_2097,var_2095,var_2096,var_2094,param2);
               if(_loc3_ != null)
               {
