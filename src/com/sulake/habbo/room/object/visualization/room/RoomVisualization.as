package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1161:int = 13421772;
      
      private static const const_763:int = 16777215;
      
      public static const const_1314:int = 10066329;
      ...
      private var var_1750:String = null;
      ...
      private var var_407:RoomPlaneBitmapMaskParser = null;
      
      private var var_1017:Number = 0;
      ...
      public function RoomVisualization()
      {
         ...
         var_407 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_77.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_275)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_77.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_275)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1236)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_228,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_407.maskCount)
         {
            _loc6_ = var_407.getMaskType(_loc5_);
            _loc7_ = var_407.getMaskLocation(_loc5_);
            _loc8_ = var_407.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_106.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_228 || _loc3_.type == RoomPlane.const_189 && _loc8_ == RoomPlaneBitmapMaskData.const_238)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc11_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              _loc3_.method_11(_loc6_,_loc12_,_loc13_);
                           }
                        }
                     }
                  }
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        if(var_77.getPlaneType(_loc9_) == RoomPlaneData.const_139)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1179)
         {
            var_1179 = param1.updateId;
            var_573 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_1017 || _loc9_.y != var_1745 || _loc9_.z != var_1749 || param1.scale != var_1754))
            {
               var_1017 = _loc9_.x;
               var_1745 = _loc9_.y;
               var_1749 = _loc9_.z;
               var_1754 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_1026);
            if(_loc10_ != var_1750)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_576));
            if(_loc11_ != var_1016)
            {
               var_1016 = _loc11_;
               var_1746 = var_1016 & 255;
               var_1748 = var_1016 >> 8 & 255;
               var_1751 = var_1016 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1747 + const_1644 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1747 = _loc7_;
         if(var_165 != _loc6_.getUpdateID())
         {
            ...
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_542);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1752 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_841));
            var_165 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_406.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_406[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_189)
            {
               if(var_1752)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1746 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1748 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1751 / 255);
