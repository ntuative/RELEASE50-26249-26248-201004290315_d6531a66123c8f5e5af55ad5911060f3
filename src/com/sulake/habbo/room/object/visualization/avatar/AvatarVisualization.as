package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_669:AvatarVisualizationData = null;
      ...
      {
         var_669 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_623);
         ...
         var _loc13_:int = param2 - var_1156;
         ...
         var _loc16_:Boolean = var_293 != _loc3_.getUpdateID() || var_214 != param1.scale || var_165 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_420 || var_478 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_478;
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_1002);
               _loc6_ = var_669.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_306);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_250) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_250);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_653);
            _loc6_.appendAction(AvatarAction.const_691,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_488);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_327,AvatarAction.const_1196[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_939);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_881,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1001);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1011);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_963,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_528);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_994,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_946);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_904,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_476);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_379) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_689,_loc32_);
            }
            ...
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_821))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_476 = var_669.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_476 = var_669.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_476 != null)
            ...
            var_801.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_801)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
