package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_784:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         if(int(_loc9_) == 0)
         {
            var_1055[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1053.push(-1);
         var_1056 = new Array();
         var_1056.push(const_1098);
         var_1056.push(const_1097);
         var_1055 = new Array();
         var_1055.push(getRandomAmplitudeFactor());
         var_1055.push(getRandomAmplitudeFactor());
      }
