package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1604:int = 1500;
      
      private var var_1605:int = 255;
      
      private var var_1603:int = 255;
      
      private var var_1369:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_705:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_414:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_238)
                  {
                     _loc8_ = "null";
                  }
                  var_407.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_527:
                  _loc7_ = var_407.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_407.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_1026,_loc10_);
            }
            return;
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_576,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1394,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1163,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1399,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_275)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_931)
         {
            ...
            {
               _loc7_ = var_1369 >> 16 & 255;
               _loc8_ = var_1369 >> 8 & 255;
               _loc9_ = var_1369 & 255;
               _loc10_ = var_1107 >> 16 & 255;
               _loc11_ = var_1107 >> 8 & 255;
               _loc12_ = var_1107 & 255;
               _loc13_ = (_loc2_ - var_931) / var_1604;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1605 + (var_1603 - var_1605) * _loc13_;
               _color = _loc3_;
               var_1366 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_576,_loc3_);
         }
      }
   }
}
