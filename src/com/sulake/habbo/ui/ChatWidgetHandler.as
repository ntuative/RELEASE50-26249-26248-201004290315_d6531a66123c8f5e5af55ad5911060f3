package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_536:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_535.length)
            {
               _loc2_ = var_535.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_535.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_769.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_333:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_535.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_769.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_722,RoomWidgetChatSelectAvatarMessage.const_740];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_722:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_151,_container.roomSession,0,"Version 26249-26248-201004290240");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_740:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_536 == null)
            {
               ...
               var_534.y = 0;
               var_534.z = 0;
               var_536 = _loc4_.getScreenPoint(var_534);
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_536.x || _loc8_.y != var_536.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_536,_loc5_));
