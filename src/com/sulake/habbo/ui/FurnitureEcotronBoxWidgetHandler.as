package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_589,RoomWidgetEcotronBoxOpenMessage.const_670,RoomWidgetEcotronBoxOpenedMessage.const_1251];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_589:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_670:
