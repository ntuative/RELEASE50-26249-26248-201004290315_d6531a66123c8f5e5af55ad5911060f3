   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_915,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_678,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_412,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_678,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_924,onAvatarEffectsChanged);
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_412,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_412:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_377));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_699);
         _loc1_.push(RoomWidgetDanceMessage.const_605);
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_587);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_556);
         ...
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1017);
         _loc1_.push(RoomWidgetToolbarMessage.const_609);
         _loc1_.push(RoomWidgetToolbarMessage.const_524);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_709);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1178);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_854);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_683);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_522);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_600);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1302);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_530);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_725);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_522:
               ...
               break;
            case RoomWidgetWaveMessage.const_699:
               if(_container != null && false)
               {
                  _container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_605:
               if(_container != null && false)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_646:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_951)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_215,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_556:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1000:
                        _catalog.openCatalogPage(CatalogPageName.const_1165,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_837:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1307:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1264:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_587:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_683:
               ...
               break;
            case RoomWidgetToolbarMessage.const_609:
               ...
               break;
            case RoomWidgetToolbarMessage.const_524:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_709:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_474));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_600:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_530:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_320,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_725:
