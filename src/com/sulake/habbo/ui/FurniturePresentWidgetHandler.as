package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_606,RoomWidgetPresentOpenMessage.const_636,RoomWidgetPresentOpenedMessage.const_1377];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_86:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_397,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_188)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_378,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                        ...
                        case ProductTypeEnum.const_287:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_411,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_606:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_161 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_143);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_636:
