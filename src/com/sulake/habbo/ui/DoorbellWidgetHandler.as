package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_104:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_523,_loc2_.userName));
               break;
      ...
      {
         return [RoomSessionDoorbellEvent.const_104,RoomSessionDoorbellEvent.const_137,RoomSessionDoorbellEvent.const_58];
      }
