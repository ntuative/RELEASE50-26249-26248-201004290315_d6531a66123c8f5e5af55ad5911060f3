package com.sulake.habbo.ui
{
   ...
   public class FurnitureCreditWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_513,RoomWidgetCreditFurniRedeemMessage.const_559];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_513:
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc8_ = new RoomWidgetCreditFurniUpdateEvent(RoomWidgetCreditFurniUpdateEvent.const_582,_loc3_.id,_loc7_);
                     _container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetCreditFurniRedeemMessage.const_559:
