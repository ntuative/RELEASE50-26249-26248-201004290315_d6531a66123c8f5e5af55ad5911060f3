package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_681);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_308);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_842);
            ...
            case RoomObjectCategoryEnum.const_39:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_333)
               {
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_528);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_230)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1342;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_943;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1281);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_597.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_597.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_621);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1221);
         _loc1_.push(RoomWidgetPetCommandMessage.const_618);
         _loc1_.push(RoomWidgetPetCommandMessage.const_549);
      ...
      public function dispose() : void
      {
         ...
         if(var_597 != null)
         {
            _loc1_ = var_597.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_597.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_475)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_508:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_849,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_628:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_621:
            ...
            case RoomWidgetUserActionMessage.const_613:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_549:
