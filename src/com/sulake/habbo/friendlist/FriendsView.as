package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_599:String = "bg";
       
      
      private var var_1623:IContainerButtonWindow;
      
      private var var_1622:IContainerButtonWindow;
      
      private var var_1625:IContainerButtonWindow;
      ...
      {
         var_1622 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1625 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1623 = initButton("room_invite",onInviteButtonClick,param1);
         var_1624 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_599);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1622,isEnableMinimailButton(_loc1_));
         setEnabled(var_1625,isEnableHomeButton(_loc1_));
         setEnabled(var_1623,isEnableInviteButton(_loc1_));
         setEnabled(var_1624,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_599);
