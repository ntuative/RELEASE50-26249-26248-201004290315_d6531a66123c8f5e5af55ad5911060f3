package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1511:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_635 = param1.gender;
         var_700 = param1.online;
         var_1161 = param1.followingAllowed && param1.online;
         var_313 = param1.figure;
         var_1383 = param1.motto;
         var_1382 = param1.lastAccess;
         var_1287 = param1.categoryId;
         var_1384 = param1.realName;
