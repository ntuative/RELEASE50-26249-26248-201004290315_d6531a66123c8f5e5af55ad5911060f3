package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1569:OpenedToWebPopup;
      ...
      private var var_2122:FriendListLookAndFeel;
      ...
      {
         var_2122 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_88 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1570 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_410.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_88.addCategory(new FriendCategory(FriendCategory.const_917,getText("friendlist.friends")));
         var_88.addCategory(new FriendCategory(FriendCategory.const_402,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_88.addFriend(new Friend(_loc4_));
         }
         var_410 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_517)
         {
            var_517 = new Timer(120000);
            var_517.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_517.start();
         }
         getBuddyRequests();
         registerListeners();
         var_199.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_517.stop();
            var_517.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_517 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_896)
         {
            var_896.release(new IIDHabboNotifications());
            var_896 = null;
         }
         if(var_199)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_410.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_292));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1570.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = var_410.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_835.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_410.findTab(FriendListTab.const_93);
      ...
      {
         var_896 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1569 == null)
         {
            var_1569 = new OpenedToWebPopup(this);
         }
         var_1569.show(x,y);
      }
