   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_364,0,0,_loc4_,var_1575,var_903,var_902));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2138 = int(_config.getKey("interstitial.interval","30000"));
         var_2137 = int(_config.getKey("interstitial.show.time","5000"));
         var_1576 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1321 = _loc2_.imageUrl;
         var_1575 = _loc2_.clickUrl;
         if(var_1321 != "" && var_1575 != "")
         {
            _loc3_ = var_1321;
            ...
            _loc4_ = new URLRequest(var_1321);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1322 = _loc2_.imageUrl;
         var_2136 = _loc2_.clickUrl;
         var_753 = getTimer();
         if(var_1322 != "")
         {
            _loc3_ = var_1322;
            ...
            var_243.start();
            _loc4_ = new URLRequest(var_1322);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_372,0,0,param1.bitmapData,var_2136));
            var_753 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1576 > 0 && var_1574 >= var_1576)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_753;
         if(_loc1_ > var_2138)
         {
            ++var_1574;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_424));
         }
      }
