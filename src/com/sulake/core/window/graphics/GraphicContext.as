package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_930:uint = 256;
      ...
      public static const const_1496:uint = 128;
      
      public static const const_1607:uint = 64;
      
      public static const const_644:uint = 4;
      
      public static const const_1216:uint = 0;
      
      public static const const_1400:uint = 16;
      
      public static const const_692:uint = 1;
      
      public static const const_1332:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_647:Boolean;
      
      protected var var_1619:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1332:
               ...
               break;
            case GraphicContext.const_1400:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_644:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_930:
               break;
            case GraphicContext.const_1216:
               break;
            default:
      ...
      public function method_5(param1:IGraphicContext) : IGraphicContext
      {
      ...
      public function removeChildContextAt(param1:int) : IGraphicContext
      {
         ...
         return _loc2_ == null ? null : method_5(_loc2_);
      }
         ...
         if(var_647)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1619,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1619,16777215);
                  }
                  var_385 += bitmap.width * bitmap.height * 4;
               }
