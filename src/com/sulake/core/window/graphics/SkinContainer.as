package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_780:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1503,var_1852);
         var_1226 = new Dictionary();
         var_1851 = new Dictionary();
         StateCodeTable.fillTables(var_1226,var_1851);
         var_503 = new Dictionary();
         var_503["skin"] = BitmapSkinRenderer;
         var_503["bitmap"] = BitmapDataRenderer;
         var_503["fill"] = FillSkinRenderer;
         var_503["text"] = TextSkinRenderer;
         var_503["shape"] = ShapeSkinRenderer;
         var_503["unknown"] = SkinRenderer;
         var_503["null"] = NullSkinRenderer;
         if(var_384 == null)
         {
            var_384 = new Array();
            var_384.push(WindowState.const_70);
            var_384.push(WindowState.const_71);
            var_384.push(WindowState.const_95);
            var_384.push(WindowState.WINDOW_STATE_SELECTED);
            var_384.push(WindowState.const_82);
            var_384.push(WindowState.const_78);
            var_384.push(WindowState.const_100);
            var_384.push(WindowState.const_89);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1226)
         {
            _loc3_.push(var_1226[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1503[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_704[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_705[param1] = new Array(SkinContainer.const_780);
         }
         var_705[param1][param2] = param3;
         if(true)
         {
            var_704[param1] = new Array(SkinContainer.const_780);
         }
         var_704[param1][param2] = param4;
      }
