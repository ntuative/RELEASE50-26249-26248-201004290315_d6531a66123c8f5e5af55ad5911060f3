package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_956:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_460 = new Array();
         var_460[0] = MouseCursorType.const_296;
         var_460[1] = MouseCursorType.const_42;
         var_460[2] = MouseCursorType.const_296;
         var_460[3] = MouseCursorType.const_296;
         var_460[4] = MouseCursorType.const_42;
         var_460[5] = MouseCursorType.const_42;
         var_460[6] = MouseCursorType.const_296;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334[0] = WindowState.const_100;
            var_334[1] = WindowState.const_78;
            var_334[2] = WindowState.const_82;
            var_334[3] = WindowState.const_70;
            var_334[4] = WindowState.WINDOW_STATE_SELECTED;
            var_334[5] = WindowState.const_95;
            var_334[6] = WindowState.const_71;
         }
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_934,param1.toolTipDelay != const_1412));
         return param2;
      }
      ...
      {
         var_955 = param1 == null ? const_747 : param1;
      }
