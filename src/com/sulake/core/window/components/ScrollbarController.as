package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1135:String = "increment";
      
      private static const const_507:String = "slider_bar";
      
      private static const const_1136:String = "decrement";
      
      private static const const_798:String = "slider_track";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_507:
         ...
         if(param2.type == WindowNotifyEvent.const_478)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_798) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_507) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_940 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_940 != null)
         {
            _loc1_ = findParentByName(var_940) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_940) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1135)
            {
               if(var_21)
               {
                  var_638 = true;
            ...
            else if(param2.name == ScrollbarController.const_1136)
            {
               if(var_21)
               {
                  var_638 = true;
            ...
            else if(param2.name == ScrollbarController.const_798)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_507).rectangle;
               if(_horizontal)
               {
