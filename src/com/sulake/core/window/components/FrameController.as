package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_792:String = "margin_right";
      
      private static const const_1112:String = "_SCALER";
      
      private static const const_1086:String = "_TITLE";
      
      private static const const_1113:String = "_CONTENT";
      
      private static const const_793:String = "margin_left";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_793,_loc3_.left,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_795,_loc3_.top,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_792,0 - _loc3_.right,PropertyStruct.const_69,_loc2_));
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_207);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1332 == null)
         {
            var_1332 = findChildByTag(const_1111) as IHeaderWindow;
            if(!var_1332)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1086) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return content != null && var_1390 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1113) as IWindowContainer;
            if(!var_20)
            {
