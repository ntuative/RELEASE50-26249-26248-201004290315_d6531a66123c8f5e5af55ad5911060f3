package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2363:Rectangle = new Rectangle();
      ...
      protected var var_549:String = "none";
      
      protected var var_646:Number;
      
      protected var var_380:Number;
      
      protected var _field:TextField;
      
      protected var var_774:Boolean = false;
      ...
      {
         return new Rectangle(var_646 * maxScrollH,var_380 * maxScrollV,width,height);
      }
      ...
      {
         var_646 = param1;
         _field.scrollH = var_646 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_213)
         {
            if(param2.type == WindowNotifyEvent.const_186)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_387,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_387,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_686,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_686,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_549,PropertyStruct.STRING,var_549 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_686,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_646 = var_646;
         _loc1_.var_380 = var_380;
         _loc1_.var_68 = var_68.clone(_loc1_.setTextMargins);
         _loc1_.var_549 = var_549;
         _loc1_.var_774 = var_774;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_549 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_549 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_549 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_549 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
