package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1411:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_162 = var_644 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_342,WindowStyle.const_294,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_551 * maxScrollH,var_552 * maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_551 = param1;
            _container.x = -var_551 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1035,_spacing,PropertyStruct.const_69,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1034,var_775,PropertyStruct.const_59,var_775 != const_1410));
         _loc1_.push(new PropertyStruct(const_1036,var_550,PropertyStruct.const_59,var_550 != const_1411));
         _loc1_.push(new PropertyStruct(const_1033,var_1122,PropertyStruct.const_59,var_1122 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_552 = param1;
            _container.y = -var_552 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_77);
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_419,param1);
            }
            else
            {
