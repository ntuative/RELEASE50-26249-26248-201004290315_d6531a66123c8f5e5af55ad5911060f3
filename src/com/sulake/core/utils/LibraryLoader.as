package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1032:int = 5;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_337 = this.getDefinition(_name) as Class;
         if(var_337 == null)
         {
         ...
         try
         {
            xmlClass = var_337.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case Event.INIT:
               ...
               var_458 |= LibraryLoader.STATE_EVENT_INIT;
               break;
            case Event.COMPLETE:
               debug("Load event COMPLETE for file \"" + var_15.contentLoaderInfo.url + "\"");
               var_458 |= LibraryLoader.STATE_EVENT_COMPLETE;
               break;
         ...
         if(var_458 == LibraryLoader.STATE_ANALYZE)
         {
            if(analyzeLibrary())
            {
               var_458 |= LibraryLoader.STATE_EVENT_FRAME;
            }
         }
         if(var_458 == LibraryLoader.STATE_READY)
         {
            var_1390 = true;
            prepareLibrary();
            removeEventListeners();
