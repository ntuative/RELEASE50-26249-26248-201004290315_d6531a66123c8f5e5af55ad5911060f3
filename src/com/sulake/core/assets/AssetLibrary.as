package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_971:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_560:uint = 0;
      
      public static const const_909:String = "AssetLibraryReady";
      
      public static const const_1296:String = "AssetLibraryUnloaded";
      
      public static const const_471:String = "AssetLibraryLoaded";
      
      public static const const_1143:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_560;
         var_390 = new Dictionary(false);
         var_391 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_390)
         {
            _loc4_ = AssetTypeDeclaration(var_390[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_391)
         {
            _loc2_ = var_391[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_391[_loc1_];
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_337 = _loc2_.resource;
         if(var_468)
         {
            AssetLibrary.fetchLibraryContents(this,var_467,var_337);
         }
         var_295 = true;
         dispatchEvent(new Event(AssetLibrary.const_471));
         dispatchEvent(new Event(AssetLibrary.const_909));
         if(var_468)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_391[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_923,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_979,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1006,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_391[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_390.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_390[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_971.splice(var_971.indexOf(this),1);
            --var_560;
            var_391 = null;
            var_655 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1143));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_390[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_655[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_15 == null)
            {
               var_15 = new LibraryLoader(var_1388);
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_337[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_391[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_390[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_337 != null ? false : false;
      }
   }
}
