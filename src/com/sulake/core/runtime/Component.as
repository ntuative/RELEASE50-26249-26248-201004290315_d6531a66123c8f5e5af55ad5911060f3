package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_892:uint = 4;
      ...
      protected var var_2359:String = "";
      
      protected var var_16:IContext = null;
      
      protected var var_2237:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_957 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_957);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1124 & const_892)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_431 + "]";
      }
