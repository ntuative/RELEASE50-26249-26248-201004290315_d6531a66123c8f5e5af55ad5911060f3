package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_614:Number = 64;
      
      public static const const_829:Number = 32;
      ...
      private var var_2366:Number = 500;
      ...
      private var var_2367:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_85 = new Vector3d();
         var_974 = new Vector3d();
         var_1416 = 1;
         var_1414 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1415 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_395 != param1 * var_1415)
         {
            var_395 = param1 * var_1415;
            ++var_76;
         }
      }
      ...
      {
         if(var_392 != param1 * var_1416)
         {
            var_392 = param1 * var_1416;
            ++var_76;
         }
      }
      ...
      {
         if(var_394 != param1 * var_1414)
         {
            var_394 = param1 * var_1414;
            ++var_76;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_393 != null)
         {
            ...
            var_393.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_393.add(_loc3_,_loc4_);
            ++var_76;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_974.assign(_loc22_);
         }
         else
         {
            var_974.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_394;
         _loc2_.z *= var_395;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_974);
         if(_loc3_ < var_2367 || _loc3_ > var_2366)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_394;
            _loc2_.z *= var_395;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_974);
         }
      ...
      {
         return new Vector3d(0 * var_392,0 * var_394,0 * var_395);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_393 != null)
         {
            ...
            return var_393.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_392,0 * var_394,0 * var_395);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_392,param2.y * var_394,param2.z * var_395);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_392,param3.y * var_394,param3.z * var_395);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_392,param4.y * var_394,param4.z * var_395);
