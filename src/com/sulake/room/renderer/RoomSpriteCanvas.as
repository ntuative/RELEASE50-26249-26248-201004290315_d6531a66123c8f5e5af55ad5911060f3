package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1643:Number = -10000000;
      
      private var var_1644:Number = -10000000;
      
      private var var_2370:int = 0;
      
      private var var_472:RoomObjectCache;
      
      private var var_663:int;
      
      private var var_251:Sprite;
      
      private var var_981:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_980 == 0)
         {
            checkMouseHits(var_982.x,var_982.y,MouseEvent.MOUSE_MOVE);
         }
         var_980 = 0;
         ++var_1425;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_51.graphics.beginFill(var_2370);
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_663 != var_1642 || var_662 != var_1645)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_396.sortOn("z",0 | 0);
         if(_loc6_ < var_396.length)
         {
            var_396.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_396[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_787.push(_loc12_ - _loc2_);
         if(var_787.length == const_753)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_753)
            {
               _loc13_ += var_787[_loc14_];
               _loc14_++;
            }
            var_787 = [];
         }
      ...
      public function dispose() : void
      {
         ...
         if(var_474 != null)
         {
            ...
            {
               cleanSprite(var_474[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_474 = [];
         }
         ...
         while(_loc1_ < var_301.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_981 != null)
                  {
                     var_981.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1425,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_396.length)
         {
            return null;
         }
         return var_396[param1] as SortableSprite;
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_473.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_473.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1643 || param2 != var_1644)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_473.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_473.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_474.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_472.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_472.getObjectCache(param2);
         ...
         _loc13_ += int(var_663 / 2);
         _loc14_ += int(var_662 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_663 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_662))
                  {
