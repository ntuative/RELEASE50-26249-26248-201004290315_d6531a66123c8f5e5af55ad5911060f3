package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               ...
               case 101010256:
                  ...
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_110))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_94 && var_95 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_544.parse(param1))
         {
            ...
            dispatchEvent(new FZipEvent(FZipEvent.const_1402,var_544));
            var_544 = null;
            if(var_95 != parseIdle)
            {
               var_95 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_48 != null && var_144 != null && param1 < var_48.length)
         {
