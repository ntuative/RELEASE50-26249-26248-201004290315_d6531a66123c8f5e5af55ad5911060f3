package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      private static var var_1075:Boolean = describeType(ByteArray).factory.method.(@name == "uncompress").hasComplexContent();
      ...
      public static const const_1457:int = 9;
      ...
      private var var_2347:int = -1;
      
      private var var_1302:uint = 0;
      ...
      private function parseFileContent(param1:IDataInput) : Boolean
      {
         if(var_1561)
         {
            ...
            _eventDispatcher.dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,"Data descriptors are not supported."));
            return false;
         }
         if(var_181 == 0)
         {
      ...
      protected function parseContent(param1:IDataInput) : void
      {
         ...
         if(var_744 === const_631 && !var_1563)
         {
            ...
            else
            {
               if(!var_515)
               {
                  _eventDispatcher.dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,"Adler32 checksum not found."));
                  return;
               }
               var_20.writeByte(120);
               _loc2_ = uint(~var_2100 << 6 & 192);
               _loc2_ += 31 - (30720 | _loc2_) % 31;
               var_20.writeByte(_loc2_);
               param1.readBytes(var_20,2,var_181);
               var_20.position = var_20.length;
               var_20.writeUnsignedInt(var_894);
            }
            var_180 = true;
         }
         else
         {
            if(var_744 != const_1319)
            {
               _eventDispatcher.dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,"Compression method " + var_744 + " is not supported."));
               return;
            }
            param1.readBytes(var_20,0,var_181);
            var_180 = false;
      ...
      {
         var_746 = param1 != null ? param1 : new Date();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1301 << 8 | 20);
         }
         else
         {
         ...
         param1.writeShort(var_1301 << 8 | 20);
         param1.writeShort(var_363 == "utf-8" ? 2048 : 0);
         param1.writeShort(const_631);
         var _loc5_:Date = var_746 != null ? var_746 : new Date();
         ...
         {
            _loc8_.writeMultiByte(var_439,var_363);
         }
         ...
         if(param2)
         {
            if(!var_515)
            {
               ...
               var_894 = ChecksumUtil.Adler32(var_20,0,var_20.length);
               var_515 = true;
               if(_loc16_)
               {
                  compress();
            ...
            _loc8_.writeShort(4);
            _loc8_.writeUnsignedInt(var_894);
         }
         ...
         if(param3 && false)
         {
            if(var_363 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_2101);
            }
            else
            {
               _loc8_.writeMultiByte(var_2101,var_363);
            }
         }
      ...
      {
         if(param1.bytesAvailable >= var_1076 + var_1302)
         {
            parseHeadExt(param1);
            var_95 = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_363 == "utf-8")
         {
            var_439 = param1.readUTFBytes(var_1076);
         }
         else
         {
            var_439 = param1.readMultiByte(var_1076,var_363);
         }
         var _loc2_:uint = var_1302;
         while(_loc2_ > 4)
         {
            ...
            if(_loc4_ > _loc2_)
            {
               _eventDispatcher.dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_110,"Parse error in file " + var_439 + ": Extra field data size too big."));
               return;
            }
            if(_loc3_ === 56026 && _loc4_ === 4)
            {
               var_894 = param1.readUnsignedInt();
               var_515 = true;
            }
            else if(_loc4_ > 0)
            {
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1563 = (_loc3_ & 1) !== 0;
         var_1561 = (_loc3_ & 8) !== 0;
         var_2099 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_363 = "utf-8";
         }
         if(var_744 === const_1175)
         {
            var_2346 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2347 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_744 === const_631)
         {
            var_2100 = (_loc3_ & 6) >> 1;
         }
         ...
         var_746 = new Date(_loc11_,_loc10_ - 1,_loc9_,_loc8_,_loc7_,_loc6_,0);
         var_745 = param1.readUnsignedInt();
         var_181 = param1.readUnsignedInt();
         var_615 = param1.readUnsignedInt();
         var_1076 = param1.readUnsignedShort();
         var_1302 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_439 + "\n  date:" + var_746 + "\n  sizeCompressed:" + var_181 + "\n  sizeUncompressed:" + var_615 + "\n  versionHost:" + var_1301 + "\n  versionNumber:" + var_1562 + "\n  compressionMethod:" + var_744 + "\n  encrypted:" + var_1563 + "\n  hasDataDescriptor:" + var_1561 + "\n  hasCompressedPatchedData:" + var_2099 + "\n  filenameEncoding:" + var_363 + "\n  crc32:" + var_745.toString(16) + "\n  adler32:" + var_894.toString(16);
      }
